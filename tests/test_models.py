...
from travian_api.models.auth import AuthStatus, JWTCache, LoginRequest, LoginResponse
from travian_api.models.buildings import Building, Resources
from travian_api.models.common import Coordinates, ResourceAmount, TroopCount, VillageInfo
from travian_api.models.military import ScoutRequest, TargetInfo, TroopComposition
...
class TestAuthModels:
    ...
    def test_auth_status(self):
        ...
        status = AuthStatus(
            is_authenticated=True, jwt_token="token123", username="test@example.com"
        )
    ...
    def test_jwt_cache_stale(self):
        ...
        cache = JWTCache(
            token="token123", username="test@example.com", server_url="https://server.com"
        )
...
class TestCommonModels:
    ...
    def test_village_info(self):
        ...
        village = VillageInfo(
            id="12345", name="Test Village", coordinates=Coordinates(x=10, y=20), population=500
        )
