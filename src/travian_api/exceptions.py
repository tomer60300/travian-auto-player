...
class SessionExpiredError(AuthError):
    ...
    def __init__(
        self, message: str = "Session expired", details: Optional[Dict[str, Any]] = None
    ) -> None:
        super().__init__(message, details)
...
class InsufficientResourcesError(BuildError):
    ...
    def __init__(
        self, message: str = "Insufficient resources", details: Optional[Dict[str, Any]] = None
    ) -> None:
        super().__init__(message, details)
...
class InsufficientTroopsError(MilitaryError):
    ...
    def __init__(
        self, message: str = "Insufficient troops", details: Optional[Dict[str, Any]] = None
    ) -> None:
        super().__init__(message, details)
...
class ChecksumError(TravianError):
    ...
    def __init__(
        self, message: str = "Failed to extract checksum", details: Optional[Dict[str, Any]] = None
    ) -> None:
        super().__init__(message, details)
...
class ActivityBudgetExhausted(TravianError):
    ...
    def __init__(
        self, message: str = "Activity budget exhausted", details: Optional[Dict[str, Any]] = None
    ) -> None:
        super().__init__(message, details)
