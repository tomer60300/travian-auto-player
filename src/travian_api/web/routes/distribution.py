...
class ExecuteRequest(PlanRequest):
    ...
    max_game_rows_per_run: int = Field(
        ...
        description=(
            ...
            "writes is the opposite of what every other control here does. The "
            "page always sends a figure -- a blank box is sent as 0, i.e. "
            "unbounded, which is the operator asking for it -- so this default "
            "governs a caller that omits the field rather than one that clears "
            "the box. 24 is one day of hourly "
