...
├───────┼───────────────┼───────┼─────────┼──────────────┼────────────┤
│ 10165 │ My Raid List  │     5 │    0    │       2h ago │      69130 │
│ 10200 │ Inactive Farms│     3 │    0    │       never  │      75483 │
└───────┴───────────────┴───────┴─────────┴──────────────┴────────────┘
```
...
My Raid List  (id=10165)
  Village: 69130  |  Running raids: 0  |  Slots: 5
...
travian farm create --name "Village 2 List" --village-id 75483
...
travian scout scan --radius 10 --village-id 75483
...
```
Scanning from ToChe`s village (-161|166) radius=10
...
travian scout auto --radius 10 --village-id 75483 --amount 1 --yes
```

```
Auto-Scout from ToChe`s village (-161|166) r=10 type=resources amount=1
  Scanning 1 map region(s) around (-161,166) r=10
  Found 45 tiles with villages/oases in radius
  Enriching 28 tiles...
