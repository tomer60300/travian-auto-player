...
- **Village ID** (`did`/`id`): Internal database ID (e.g., `69130`). Used in API calls and `newdid` parameter.
...
```
/dorf1.php?newdid=75483          → Resource view for village 75483
/dorf2.php?newdid=75483          → Building view for village 75483
/build.php?newdid=75483&id=1     → Building slot 1 in village 75483
/build.php?newdid=75483&gid=16&tt=2  → Rally Point send troops for village 75483
```
...
**Verified behavior:**
```
GET /dorf1.php?newdid=75483  → resources for village 75483
GET /dorf1.php               → still village 75483 (session persisted)
GET /dorf1.php?newdid=69130  → back to village 69130
```

### After Switching — Active Village Changes Everywhere

After `?newdid=75483`:
- `ownPlayer.village` in GraphQL returns village 75483
- Resource data (`var resources = {...}`) shows village 75483's resources
- Building pages show village 75483's buildings
- Checksums change (each village has its own CSRF token)
- Troop counts in rally point show village 75483's troops
...
<div id="sidebarBoxVillageList">
    <div class="listEntry active" data-did="69130">
        <a href="?newdid=69130&amp;">
            <span class="name" data-did="69130">ToChe`s village</span>
            <span class="coordinates">(−161|166)</span>
        </a>
    </div>
    <div class="listEntry" data-did="75483">
        <a href="?newdid=75483&amp;">
            <span class="name" data-did="75483">New village</span>
...
r = s.get(f"{BASE}/build.php?newdid=75483&id=1")
...
```python
# Send troops from village 75483
r = s.get(f"{BASE}/build.php?newdid=75483&gid=16&tt=2")
...
{
    "data": [
        {"villageId": 69130, "name": "Main Village"},
        {"villageId": 75483, "name": "Farm Village"}
    ]
}
```
